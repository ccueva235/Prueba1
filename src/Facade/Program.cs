...
builder.Services.Configure<SqlProperty>(info => builder.Configuration.GetSection("Sql").Bind(info));
builder.Services.Configure<SettingProperty>(info => builder.Configuration.GetSection("Setting").Bind(info));
builder.Services.Configure<ConsultaApiSunat>(info => builder.Configuration.GetSection("ConsultaSunat").Bind(info));
